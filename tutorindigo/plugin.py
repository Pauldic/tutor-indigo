...
config: t.Dict[str, t.Dict[str, t.Any]] = {
    ...
    "defaults": {
        "VERSION": __version__,
        "WELCOME_MESSAGE": "The place for all NACAR online learning",
...
hooks.Filters.ENV_PATTERNS_INCLUDE.add_items([
    ...
    r"indigo/cms/static/css/" # nah me add am
])
...
RUN npm install '@pauldic/frontend-component-footer@1.0.18'
RUN npm install '@edx/frontend-component-header@npm:@edly-io/indigo-frontend-component-header@^4.0.0'
...
for path in glob(os.path.join(str(importlib_resources.files("tutorindigo") / "patches"), "*")):
